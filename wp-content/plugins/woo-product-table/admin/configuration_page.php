...
function wptf_configuration_page(){
    ...
    if( isset( $_POST['data'] ) && isset( $_POST['reset_button'] ) ){
        ...
        $value['sort_searchbox_filter'] = $default['sort_searchbox_filter'];
    ...
    <div class="wrap wptf_wrap wptf_configure_page">
        <h2 class="plugin_name"><?php echo WPT_Product_Table::getName(); ?> <span class="plugin_version">v <?php echo WPT_Product_Table::getVersion(); ?></span></h2>
        <hr>
        <!-- New Version's Warning. We will remove it from 5.00 | Start -->
        <h3 style="color: #ffa600;font-weight: normal;padding: 0;margin: 0;"><span style="font-weight: bold;color: #d00;">[[ Warning for Old user ]]</span> Old shortcode System has been removed from V1.5. such: [Product_Table column_keywords='' column_title=''] or [WPT_SHOP]</h3>
        <p style="padding: 0;margin: 0;">That's why, you have to create new shortcode: Dashboard->PRODUCT TABLE->Add new shortcode . Otherwise, you have to use old version. Old version plugin is available Main File folder.</p>
        <h3 style="margin: 0">
        ...
        <hr>
        <h1><?php esc_html_e( 'Table Configuration', 'wptf_pro' );?></h1>
                ...
                <form action="" method="POST">
                    ...
                    <table class="wptf_config_form">
                        <tbody>
                            ...
                            <tr>
                                <div class="wptf_column">
                                    <th><label class="wptf_label" for="wpt_table_hide_for_zerro"><?php esc_html_e( 'Footer Cart Option', 'wpt_pro' );?></label></th>
                                    <td>
                                        <select name="data[footer_cart]" id="wpt_table_hide_for_zerro" class="wpt_fullwidth" >
                                            <option value="hide_for_zerro" <?php wptf_selected( 'footer_cart',  'hide_for_zerro' );?>><?php esc_html_e( 'Hide for Zeor', 'wpt_pro' );?></option>
                                            <option value="always_show" <?php wptf_selected( 'footer_cart',  'always_show' );?>><?php esc_html_e( 'Always Show', 'wpt_pro' );?></option>
                                            <option value="always_hide" <?php wptf_selected( 'footer_cart',  'always_hide' );?>><?php esc_html_e( 'Always Hide', 'wpt_pro' );?></option>
                                        </select>
