<div class="wptf_rightside">
    <div class="wptf_right_side_in_wrapper" style="padding: 10px;">
        <div class="social_title_wrapper">
            <h2 class="social_title"><img src="<?php echo WPT_Product_Table::getPath( 'BASE_URL' ); ?>images/social/social.png"> Share on Social Network</h2>
            ...
            <div class="social_links">
                ...
                <a href="http://www.facebook.com/sharer.php?u=<?php echo esc_attr( $url_for_share ); ?>" title="Your Share, My best Gift" target="_blank">
                    <img src="<?php echo WPT_Product_Table::getPath( 'BASE_URL' ); ?>images/social/facebook.png">
                </a>
                ...
                <a href="http://twitter.com/share?text=<?php echo urlencode("Best #Quick_Order Plugin for #WooCommerce #Product #Table Pro - #WPTpro | #" . rand(88,2934)); ?>&url=<?php echo esc_attr( $url_for_share ); ?>&via=CodeAstrology" title="Your Share, My best Gift" target="_blank">
                    <img src="<?php echo WPT_Product_Table::getPath( 'BASE_URL' ); ?>images/social/twitter.png">
                </a>
                ...
                <a href="https://plus.google.com/share?url=<?php echo esc_attr( $url_for_share ); ?>&t=<?php echo urlencode("Best Quick Order Plugin for WooCommerce Product Table Pro"); ?>" title="Your Share, My best Gift" target="_blank">
                    <img src="<?php echo WPT_Product_Table::getPath( 'BASE_URL' ); ?>images/social/google.png">
                </a>
                ...
                <a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo esc_attr( $url_for_share ); ?>&title=<?php echo urlencode("Best Quick Order Plugin for WooCommerce Product Table Pro"); ?>" title="Your Share, My best Gift" target="_blank">
                    <img src="<?php echo WPT_Product_Table::getPath( 'BASE_URL' ); ?>images/social/linkedin.png">
                </a>
                ...
                <a href="http://www.reddit.com/submit?url=<?php echo esc_attr( $url_for_share ); ?>&title=<?php echo urlencode("Best Quick Order Plugin for WooCommerce Product Table Pro"); ?>" title="Your Share, My best Gift" target="_blank">
                    <img src="<?php echo WPT_Product_Table::getPath( 'BASE_URL' ); ?>images/social/reddit.png">
                </a>
                ...
                <a href="https://mail.google.com/mail/u/0/?view=cm&fs=1&su=<?php echo urlencode("Best Quick Order Plugin for WooCommerce Product Table Pro"); ?>&body=<?php echo esc_attr( $url_for_share ); ?>&ui=2&tf=1" title="Your Share, My best Gift" target="_blank">
                    <img src="<?php echo WPT_Product_Table::getPath( 'BASE_URL' ); ?>images/social/gmail.png">
                </a>
    ...
    <div class="wptf_right_side_in_wrapper" style="padding: 10px;">
        <div class="need_help_wrapper">
            ...
            <a style="display: block;text-align: left;" target="_blank" href="https://codeastrology.com/support/">
                <img style="max-width: 100px" src="<?php echo WPTF_BASE_URL; ?>images/customer_support.png">
            ...
            <span>Facebook: <a target="_blank" href="https://www.facebook.com/messages/t/CodeAstrology" target="_blank">Message to CodeAstorlogy</a></span>
    ...
    <div class="wptf_right_side_in_wrapper" style="padding: 10px;">
        <div class="need_help_wrapper">
            <h3 style="margin:4px 0px"><a target="_blank" href="https://codecanyon.net/item/woocommerce-beautifier/23386133">WooCommerce Beautifier</a></h3>
			<p>WooCommerce Beautifier plugin gives you a plenty of options to customize the design of your WooCommerce shop. With this plugin you will be able to change/customize Design/Style/Color/Font-Size etc of your Shop page content, Minicart content, Cart page content, Checkout page content, Category and Tag page content. Such as product title, price,add to cart button,sale badge,page title,placeorder button, select option button etc. You can chage color, font size,font style,font-family,padding,background color etc.</p>
            <a target="_blank" href="https://codecanyon.net/item/woocommerce-beautifier/23386133"><img width=100%; src="<?php echo WPTF_BASE_URL; ?>images/wc_beautifier.png"</a>
        </div>
    </div>
	
    <div class="wptf_right_side_in_wrapper" style="padding: 10px;">
        <div class="need_help_wrapper">
            <h3><a target="_blank" href="https://www.facebook.com/groups/CodeAstrology/">Join FB Group</a></h3>
        </div>
    </div>
    <div class="wptf_right_side_in_wrapper" style="padding: 10px;">
        <div class="rate_us_wrapper">
            <a href="https://codecanyon.net/downloads" target="_blank"><img class="rate_us_image" src="<?php echo WPT_Product_Table::getPath( 'BASE_URL' ); ?>images/rate_us.png"></a>
            <h1>It can take only 2 Minutes.</h1>
            <h3><a href="https://wordpress.org/support/plugin/woo-product-table/reviews/?rate=5#new-post" target="_blank">Rate Us</a></h3>
        </div>
    </div>
