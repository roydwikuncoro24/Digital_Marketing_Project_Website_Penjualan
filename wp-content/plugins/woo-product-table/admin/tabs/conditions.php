...
<div style="display: none;" class="wptf_column" id="wptf_meta_value_wrapper">
    ...
    <p style="color: #00aef0;"><?php esc_html_e( 'Type your Right meta value here. EG: "_sku", there should now and space', 'wptf_pro' ); ?></p>
</div>
...
<div class="wptf_column">
    ...
    <input name="conditions[min_price]" data-name='min_price' value="<?php echo isset( $meta_conditions['min_price'] ) ?$meta_conditions['min_price'] : ''; ?>" id="wptf_product_min_price" class="wptf_fullwidth wptf_data_filed_atts" type="number"  name="wptf_form_array[wptf_product_min_price]" pattern="[0-9]*">
</div>
<div class="wptf_column">
    <label class="wptf_label" for="wptf_product_max_price"><?php esc_html_e( 'Set Maximum Price', 'wptf_pro' ); ?></label>
    <input name="conditions[max_price]" data-name='max_price' value="<?php echo isset( $meta_conditions['max_price'] ) ?$meta_conditions['max_price'] : ''; ?>" id="wptf_product_max_price" class="wptf_fullwidth wptf_data_filed_atts" type="number"  name="wptf_form_array[wptf_product_max_price]" pattern="[0-9]*">
</div>
<div class="wptf_column">
...
<div class="wptf_column">
    ...
    <select name="conditions[only_stock]" data-name='only_stock' id="wptf_table_only_stock" class="wptf_fullwidth wptf_data_filed_atts" >
        <option value="no" <?php echo isset( $meta_conditions['only_stock'] ) && $meta_conditions['only_stock'] == 'no' ? 'selected' : ''; ?>><?php esc_html_e( 'All Product', 'wptf_pro' ); ?></option>
        <option value="yes" <?php echo isset( $meta_conditions['only_stock'] ) && $meta_conditions['only_stock'] == 'yes' ? 'selected' : ''; ?>><?php esc_html_e( 'Yes (Only Stock)', 'wptf_pro' ); ?></option>
    </select>
</div>
...
<div class="wptf_column">
    ...
    <input name="conditions[posts_per_page]" data-name='posts_per_page' value="<?php echo isset( $meta_conditions['posts_per_page'] ) ?$meta_conditions['posts_per_page'] : '20'; ?>" id="wptf_posts_per_page" class="wptf_fullwidth wptf_data_filed_atts" type="number"  name="" pattern="[0-9]*" placeholder="<?php esc_attr_e( 'Eg: 50 (for display 20 products', 'wptf_pro' ); ?>" value="20">
</div>