...
<div class="wptf_column wptf_disable_column">
    ...
    <select name="basics[ajax_action]" data-name='ajax_action' id="wptf_table_ajax_action" class="wptf_fullwidth wptf_data_filed_atts" >
        <option value="ajax_active" <?php echo isset( $meta_basics['ajax_action'] ) && $meta_basics['ajax_action'] == 'ajax_active' ? 'selected' : false; ?>><?php esc_html_e('Active Ajax (Default)','wptf_pro');?></option>
        <option value="no_ajax_action" <?php echo isset( $meta_basics['ajax_action'] ) && $meta_basics['ajax_action'] == 'no_ajax_action' ? 'selected' : false; ?>><?php esc_html_e('Disable Ajax Action','wptf_pro');?></option>
    </select>
</div>
