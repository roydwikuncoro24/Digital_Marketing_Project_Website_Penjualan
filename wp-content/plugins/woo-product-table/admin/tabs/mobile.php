...
<div class="wptf_column wptf_disable_column">
    <label class="wptf_label" for="wptf_table_mobile_responsive"><?php esc_html_e( 'Mobile Responsive', 'wptf_pro' ); ?></label>
    <select name="mobile[mobile_responsive]" data-name='mobile_responsive' id="wptf_table_mobile_responsive" class="wptf_fullwidth wptf_data_filed_atts" >
        <option value="mobile_responsive" <?php echo isset( $meta_mobile['mobile_responsive'] ) && $meta_mobile['mobile_responsive'] == 'mobile_responsive' ? 'selected' : ''; ?>><?php esc_html_e( 'Default (Yes Responsive)', 'wptf_pro' ); ?></option>
        <option value="no_responsive" <?php echo isset( $meta_mobile['mobile_responsive'] ) && $meta_mobile['mobile_responsive'] == 'no_responsive' ? 'selected' : 'selected'; ?>><?php esc_html_e( 'No Responsive', 'wptf_pro' ); ?></option>
    </select>
...
<ul id="wptf_keyword_hide_mobile">
    <h1 style="color: #D01040;"><?php esc_html_e( 'Hide On Mobile', 'wptf_pro' ); ?></h1>
    <p style="padding: 0;margin: 0;"><?php esc_html_e( 'Pleach check you column to hide from Mobile. For all type Table(Responsive or Non-Responsive).', 'wptf_pro' ); ?></p>
    <hr>
        <?php
    ...
    <li class="hide_on_mobile_permits <?php echo $enabled_class; ?> column_keyword_<?php echo esc_attr( $keyword ); ?>">
        ...
        <span title="<?php echo esc_attr( $keyword ); ?>"  title="<?php esc_attr_e( 'Move Handle', 'wptf_pro' ); ?>" class="handle checkbox_handle">
            <input  name="mobile[disable][]" value="<?php echo esc_attr( $keyword ); ?>"  title="<?php esc_attr_e( 'Active Inactive Column', 'wptf_pro' ); ?>" class="checkbox_handle_input <?php echo $enabled_class; ?>" type="checkbox" data-column_keyword="<?php echo esc_attr( $keyword ); ?>" <?php echo $checked_attribute; ?>>
        </span>
    </li>
    <?php
