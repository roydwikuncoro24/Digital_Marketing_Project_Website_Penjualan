...
if( !class_exists( 'Ni_COG_Top_Profit_Product' ) ) { 
	class Ni_COG_Top_Profit_Product{
		...
		function page_init(){
			...
			$page_titles 				= array(
					'today_top_product'			=> __('Today Top Profit Product',		'nisalesreportpro')
					,'yesterday_top_product'		 	=> __('Yesterday Profit Top Product',	'nisalesreportpro')
					,'last_7_days_top_product'		=> __('Last 7 Days Profit Top Product',	'nisalesreportpro')				
			);
			?>
		...
		function get_top_product_columns(){
			...
			$column["product_profit"]= __('Product Profit', 'nisalesreport');
			return $column;
		}
		...
		function get_top_product(){
            ...
            <table class="ni-cog-table">
            	...
            	<tbody>
                 <?php if (count($rows)==0): ?>
                 	<tr>
                    	<td colspan="4" style="text-align:left; font-size:16px"><?php _e('No product found', 'nisalesreport'); ?></td>
                    </tr>
                    </tbody>
                 <?php endif; ?>
